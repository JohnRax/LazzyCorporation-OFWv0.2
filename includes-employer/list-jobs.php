                                   ...
                                   echo "<div class='col-md-4 p0'>
                                        <div class='box-two proerty-item'>
                                            <div class='item-thumb'>
                                                <a href='property-1.html' ><img src='assets/img/profilepicture/".$result['j_logo']."'></a>
                                            </div>
                                            ...
                                            <div class='item-entry overflow'>
                                                ...
                                                <div class='dot-hr'></div>
                                                    ...
                                                    <div class='dealer-action pull-left'>                                        
                                                        ...
                                                        <a href='index-employer.php?source=listpostjobs&id=".$result['j_id']."' class='button delete_user_car'>Delete</a>";
                                                    ?>
